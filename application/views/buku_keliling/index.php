...
<style>
    ...
    <a href="<?= base_url() ?>buku_keliling/tambah"  class="btn btn-sm btn-primary btn-icon-split">
                        ...
                        <tbody style="cursor:pointer;">
                            ...
                            <tr>
                                ...
                                <td onclick="detail('<?= $b->id ?>')"><img style="border-radius: 5px;"
                                        src="assets/upload/buku_keliling/<?= $b->foto ?>" alt="" width="50px"></td>
                                ...
                                <td>
                                    <center>
                                        <a href="<?= base_url() ?>buku_keliling/ubah/<?= $b->id ?>"
