...
<style>
    ...
    <div class="dropdown">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="<?= base_url() ?>buku_keliling/ExportPdf"><i class="fas fa-file-pdf"></i>  PDF</a>
                    <a class="dropdown-item" href="<?= base_url() ?>buku_keliling/export"><i class="fas fa-file-excel"></i>  EXCEL</a>
                </div>
    
                <button class="btn btn-sm btn-primary btn-icon-split" type="button" aria-popup="true" aria-expanded="true">
                        <a href="<?= base_url() ?>buku_keliling/print" style="text-decoration:none">
        ...
        <center>
            <br><h3 class=""><b> LAPORAN PEMBELIAN BUKU KELILING </b></h3> 
        </center>
                ...
                <div class="table-responsive">
                    <table class=" table table-bordered table-hover table" id="dtHorizontalExample" width="100%" cellspacing="0">
                        ...
                        <tbody style="cursor:pointer;">
                            <?php $no=1; foreach ($buku_keliling as $b) { ?>
                            <tr>
