...
<style>
    ...
    <form action="<?= base_url() ?>buku_keliling/proses_ubah" name="myForm" method="POST" enctype="multipart/form-data"
            ...
            <div class="col-lg-8 mb-4">
                ...
                <div class="card border-bottom-primary shadow mb-4">
                    <div class="card-header bg-primary py-3">
                        <h6 class="m-0 font-weight-bold text-white">Form Edit Buku buku_keliling</h6>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-4 mb-4">
                ...
                <div class="card border-bottom-primary shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <center>
                            <div id="img">
                                <img src="<?= base_url() ?>assets/upload/buku_keliling/<?= $d->foto ?>" id="outputImg"
                                    width="200" maxheight="300">
                            </div>
                            <div id="pdf">
                                <embed src="<?= base_url() ?>assets/upload/buku_keliling/<?= $d->foto ?>" id="outputPdf"
