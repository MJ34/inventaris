...
<div class="container-fluid">
    ...
    <form action="<?= base_url() ?>pegawai/proses_ubah" name="myForm" method="POST" enctype="multipart/form-data"
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <div class="d-sm-flex">
                ...
                &nbsp;
                <h1 class="h2 mb-0 text-gray-800">Ubah pegawai</h1>
            </div>
                ...
                <div class="card border-bottom-primary shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="col-lg-12">
                            ...
                            <!-- Id -->
                            <div class="form-group"><label>ID pegawai</label>
                                <input class="form-control" name="id" type="text"
                                    value="<?= $d->id_pegawai ?>" readonly>
                            </div>
                ...
                <div class="card border-bottom-primary shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="card bg-warning text-white shadow">
                            <div class="card-body">
                                Format
                                <div class="text-white-45 small">.jpeg .jpg .tiff .gif .tif</div>
                            </div>
                        </div>
                        <br>
                        <center>
                            <div id="img">
                                <img src="<?= base_url() ?>assets/upload/pegawai/<?= $d->foto ?>" id="outputImg"
                                    width="200" maxheight="300">
                            </div>
                            <div id="pdf">
                                <embed src="<?= base_url() ?>assets/upload/pegawai/<?= $d->foto ?>" id="outputPdf"
...
<script src="<?= base_url(); ?>assets/js/validasi/pegawaiform.js"></script>
