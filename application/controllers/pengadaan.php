...
class Pengadaan extends CI_Controller {
	...
	public function Print(){
		$data['pengadaan'] = $this->pengadaan_model->dataJoin()->result();
		$this->load->view('pengadaan/print', $data);
	}
	...
	public function ExportPdf(){
			...
			$this->pdf->filename = "laporan pengadaan buku.pdf";

			$this->pdf->load_view('pengadaan/pdf', $data);
		}

	public function export(){
		
		$data['pengadaan'] = $this->pengadaan_model->dataJoin()->result();
		$this->load->view('pengadaan/excel', $data);
