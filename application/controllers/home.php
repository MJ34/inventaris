...
class Home extends CI_Controller {
	...
	public function index()
	{
		...
		$data['jmlpembelian'] = $this->pembelian_model->data()->num_rows();
		$data['jmlhibah'] = $this->hibah_model->data()->num_rows();
		$data['jmlbuku_keliling'] = $this->buku_keliling_model->data()->num_rows();
		$data['jmlpegawai'] = $this->pegawai_model->data()->num_rows();
